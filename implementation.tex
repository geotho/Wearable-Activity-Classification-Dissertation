\chapter{Implementation}
  ...
  \section{Activity analysis}
    ...
    \subsection{Climbing}
      \begin{figure}[!th]
        \centering
        \includegraphics[width=1.0\textwidth]{2by2climbing}
    ...
    \subsection{Eating}
      \begin{figure}[!th]
        \centering
        \includegraphics[width=1.0\textwidth]{2by2eating}
    ...
    \subsection{Gallery perusal}
      \begin{figure}[!th]
        \centering
        \includegraphics[width=1.0\textwidth]{2by2gallery}
    ...
    \subsection{Gym cycling}
      \begin{figure}[!th]
        \centering
        \includegraphics[width=1.0\textwidth]{2by2gymcycling}
    ...
    \subsection{Running}
      \begin{figure}[!th]
        \centering
        \includegraphics[width=1.0\textwidth]{2by2running}
    ...
    \subsection{Teeth brushing}
      \begin{figure}[!th]
        \centering
        \includegraphics[width=1.0\textwidth]{2by2teethbrushing}
